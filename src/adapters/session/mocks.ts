  ...
  exercises: [
    {
      ...
      question:
        'I _____ to Paris three times in my life. It\'s such a beautiful city!',
      options: [
        'have been',
        'am been',
        'was being',
...

    {
      ...
      question: 'She _____ (not / see) that movie yet, but she wants to watch it this weekend.',
...

    {
      ...
      type: ExerciseType.SINGLE_CHOICE,
      question:
        'How long _____ you _____ English? Since you were a child?',
      options: [
        'have / studied',
        'have / been studying',
        'are / studying',
  ...
  exercises: [
    {
      ...
      type: ExerciseType.SINGLE_CHOICE,
      question:
        'I _____ in the IT industry for 5 years now. It\'s very rewarding work.',
      options: [
        'have worked',
        'worked',
        'am working',
